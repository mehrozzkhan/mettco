...
export const industries = [
  { name: "Manufacturing", slug: "manufacturing", icon: "Factory", image: "/images/industries/manufacturing.png", blurb: "MRO and production supply for round-the-clock plants.", supplies: ["Bearings & power transmission", "Motors, drives & pumps", "MRO consumables & lubricants", "Machine spares & tooling"] },
  { name: "Textile Mills", slug: "textile", icon: "Shirt", image: "/images/industries/textile.png", blurb: "Spares and consumables for spinning & weaving.", supplies: ["Ring frame & loom spares", "Rollers, aprons & cots", "Compressed air components", "Humidification & filtration"] },
  { name: "Food Processing", slug: "food-processing", icon: "UtensilsCrossed", image: "/images/industries/food-processing.png", blurb: "Food-grade equipment, components and packaging.", supplies: ["Food-grade conveyor components", "Stainless fittings & valves", "Hygienic lubricants", "Primary & secondary packaging"] },
  { name: "Warehousing", slug: "warehousing", icon: "Warehouse", image: "/images/industries/warehousing.png", blurb: "Racking, handling and safety systems at scale.", supplies: ["Racking & storage systems", "Material handling equipment", "Dock & door hardware", "Safety barriers & signage"] },
  { name: "Logistics", slug: "logistics", icon: "Truck", image: "/images/industries/logistics.jpg", blurb: "Equipment that keeps supply chains moving.", supplies: ["Strapping & load securing", "Pallets & containers", "Fleet consumables", "Warehouse packaging lines"] },
  { name: "Construction", slug: "construction", icon: "HardHat", image: "/images/industries/construction.jpg", blurb: "Fasteners, site safety and supplies at project scale.", supplies: ["Fasteners & anchors", "Site safety & PPE", "Formwork accessories", "Power tools & consumables"] },
  { name: "Engineering Firms", slug: "engineering", icon: "DraftingCompass", image: "/images/industries/engineering.png", blurb: "Precision components and technical sourcing.", supplies: ["Precision components to spec", "Instrumentation & measurement", "Custom machined parts", "Obsolete part re-sourcing"] },
  { name: "Packaging", slug: "packaging", icon: "Package", image: "/images/industries/packaging.png", blurb: "Industrial packaging at consistent quality and scale.", supplies: ["Stretch film & shrink wrap", "Strapping systems", "Corrugated & cartons", "Protective packaging"] },
  { name: "Agriculture", slug: "agriculture", icon: "Wheat", image: "/images/industries/agriculture.png", blurb: "Durable equipment for modern agribusiness.", supplies: ["Irrigation components", "Processing machinery spares", "Storage & handling", "Crop packaging materials"] },
];
